...
@primitive("screensize")
def tscheme_screensize(x, y):
    """Set the screensize to x, y"""
    _tscheme_prep()
    turtle.screensize(x, y)
    return okay

@primitive("setup")
def tscheme_setup(x, y):
    """Set the setup to x, y"""
    _tscheme_prep()
    turtle.setup(x, y)
    return okay

@primitive("set-color")
def tscheme_setcolor(c):
    _tscheme_prep()
    turtle.color(c)
    return okay
